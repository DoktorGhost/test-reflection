...
generate-go-disc_service_v1-api:
	...
	GOBIN=$(LOCAL_BIN) protoc \
	--proto_path . \
	--proto_path api/grpc/protobuf/disc_service_v1 \
	--go_out=src/go/pkg/grpc/disc_service \
	--go_opt=paths=source_relative \
	--go-grpc_out=src/go/pkg/grpc/disc_service \
	--go-grpc_opt=paths=source_relative \
	--plugin=protoc-gen-go=bin/protoc-gen-go \
	--plugin=protoc-gen-go-grpc=bin/protoc-gen-go-grpc \
	--plugin=protoc-gen-doc=bin/protoc-gen-doc \
	--doc_out=. \
	--doc_opt=markdown,README.md,source_relative \
	api/grpc/protobuf/disc_service_v1/*.proto